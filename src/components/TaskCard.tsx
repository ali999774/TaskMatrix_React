  ...
  const cardInner = (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p
          className={`text-[0.78125rem] font-semibold leading-snug ${
            isDone
        ...
        {(task.category || dueInfo) && (
          <p className="text-[0.65625rem] leading-relaxed mt-0.5 flex items-center gap-1.5 flex-wrap" aria-hidden="true">
            {dueInfo && (
