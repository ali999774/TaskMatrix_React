...
export default function App() {
  ...
  return (
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 overflow-x-hidden w-full max-w-full">
      {/* Top bar */}
      <header className="fixed top-0 left-0 right-0 z-40 bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 pt-safe">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 pb-[env(safe-area-inset-bottom)]">
