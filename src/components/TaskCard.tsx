  ...
  const cardInner = (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p
          className={`text-[var(--font-size-task-title)] font-semibold leading-snug ${
            isDone
        ...
        {(task.category || dueInfo) && (
          <p className="text-[var(--font-size-meta)] leading-relaxed mt-0.5 flex items-center gap-1.5 flex-wrap" aria-hidden="true">
            {dueInfo && (
